...
import eu.fincon.hellosoap.service.internal.AnswerRepository;
...
public class HelloSOAPEndpoint implements HelloSOAPPort {
	...
	@Autowired
	public HelloSOAPEndpoint(AnswerRepository answerRepository) {
	...
	public GetHelloSOAPResponse getHelloSOAP(@RequestPayload GetHelloSOAPRequest getHelloSOAPRequest) {
		...
		response.setAnswer(answerRepository.getAnswerWithName(getHelloSOAPRequest.getName()));
		return response;
	}
